      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Kullanıcı Bilgileri</a>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Bilgilerinizi Güncelleyin</h4>
                  <p class="card-category">Şifre ve ya kullanıcı adı değişikliği yapabilirsiniz.</p>
                </div>
                <div class="card-body">
                  <form action="worker/UserGuncelle.php" method="POST">
                    <div class="row">
<div class="col-md-3">
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="#pablo">
                  <img class="img" src="https://icon-library.com/images/webmaster-icon/webmaster-icon-13.jpg" />
                  </a>
                </div>
                <div class="card-body">
                  <h6 class="card-category">bilgilendirme</h6>
                  <h4 class="card-title">Kullanıcı Bilgileriniz Hakkında</h4>
                  <p class="card-description"> Şifreleriniz MD5 şifreleme tekniği ile şifrelenip veri tabanına işlenir. Daha güvenli bir giriş sistemi elde etmiş olursunuz. Önlem niteliğinde lütfen kişisel bilgilerinizi asla kötü şahıslara emel etmeyiniz. </p>
</div>
              </div>
            </div>
          </div>
