      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Sistemde Olan Domainler</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Domain Tablosu</h4>
                  <p class="card-category"> Kayıt Edilen Domainler Burada Gözükür.</p>
                </div>
                <div class="card-body">
